    ...
    <>
      ...
      <div className="mx-auto w-full max-w-md">
        <table className="w-full select-none">
          <thead>
            <tr className="grid grid-cols-[44px_1fr_64px] gap-2 border-b-2 border-stone-400 px-2 py-2 text-xs font-bold uppercase dark:border-stone-600">
              <th>Rank</th>
          ...
          <tbody className="divide-y divide-stone-400 dark:divide-stone-600">
            {countries.map((country, i) => {
              ...
              if (country.slug === 'sk') console.log(prevScore, score)

              return (
                <tr
                  key={country.slug}
                  className="relative grid grid-cols-[44px_1fr_64px] items-center gap-2 px-2 py-2 text-lg transition-colors hover:bg-white dark:hover:bg-stone-950"
                >
                  ...
                  <td className="text-center text-sm font-bold">{score}</td>
                </tr>
              )
            })}
          </tbody>
